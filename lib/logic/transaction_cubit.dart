...
class TransactionCubit extends Cubit<TransactionState> {
  ...
  TransactionCubit(this._service) : super(TransactionInitial());
  ...
  Future<void> getAllTransactions() async {
    ...
    try {
      ...
      emit(TransactionError('Erreur lors du chargement des transactions'));
    }
  }
  ...
  Future<void> getTransactionDetails(String id) async {
    ...
    try {
      ...
      emit(TransactionError('Erreur lors du chargement des détails de la transaction'));
    }
  }
}